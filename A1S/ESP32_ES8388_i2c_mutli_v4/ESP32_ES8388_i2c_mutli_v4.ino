...
/*          wifiMulti.addAP(credential[0].ssid, credential[0].pass);
          wifiMulti.addAP(credential[1].ssid, credential[1].pass);
          wifiMulti.addAP(credential[2].ssid, credential[2].pass);
          wifiMulti.addAP(credential[3].ssid, credential[3].pass);
          wifiMulti.addAP(credential[4].ssid, credential[4].pass);
*/          
    #endif
    #ifdef WIFI_SINGLE
